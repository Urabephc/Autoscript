...
sed -i 's|export KEY_EMAIL="urabevpn@gmail.com"|export KEY_EMAIL="urabevpn@gmail.com"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU="MyOrganizationalUnit"|export KEY_OU="urabe"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_NAME="EasyRSA"|export KEY_NAME="urabe"|' /etc/openvpn/easy-rsa/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=urabe|' /etc/openvpn/easy-rsa/vars
