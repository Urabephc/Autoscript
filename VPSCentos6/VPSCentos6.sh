...
# install openvpn
wget -O /etc/openvpn/keys.zip "https://github.com/Urabephc/Autoscript/raw/master/VPSCentos6/keys.zip"
cd /etc/openvpn/
unzip keys.zip
wget -O /etc/openvpn/server.conf "https://github.com/Urabephc/Autoscript/raw/master/VPSCentos6/server.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/server.conf "https://github.com/Urabephc/Autoscript/raw/master/VPSCentos6/server.conf"
fi
...
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/Urabephc/Autoscript/master/VPSCentos6/client.ovpn"
