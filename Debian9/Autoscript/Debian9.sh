...
cd
apt-get install dnsutils dsniff
wget "https://raw.githubusercontent.com/Urabephc/Autoscript/master/Debian9/Autoscript/ddos-deflate-master.zip
...
echo "   - Download Config OpenVPN : http://$MYIP/configs.ovpn"  | tee -a log-install.txt
